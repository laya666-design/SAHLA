...
/// Écran "mot de passe oublié" pour le login acheteur (email/mot de passe).
...
class _BuyerForgotPasswordScreenState
  ...
  Future<void> _sendReset() async {
    ...
    try {
      await MarketplaceService.sendPasswordResetEmail(email);
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                "Indique l'email de ton compte acheteur, on t'envoie un "
